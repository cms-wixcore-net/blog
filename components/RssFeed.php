...
{
    # Колекція дописів для відображення
    public $posts;
    # Якщо список дописів потрібно відфільтрувати за категорією, використовуйте модель.
    public $category;
    # Посилання на назву головної сторінки блогу.
    public $blogPage;
    # Посилання на назву сторінки для посилань на публікації.
    public $postPage;
    ...
    protected function listPosts()
    {
        ...
        # Перерахуйте всі публікації, завантажуйте їх категорії
        ...
        # Додайте допоміжний атрибут "url" для посилань на кожну публікацію та категорію
