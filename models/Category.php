<?php namespace WixCore\Blog\Models;
...
class Category extends Model
{
    ...
    public $belongsToMany = [
        'posts' => ['WixCore\Blog\Models\Post',
            'table' => 'wixcore_blog_posts_categories',
            'order' => 'published_at desc',
            'scope' => 'isPublished'
        ],
        'posts_count' => ['WixCore\Blog\Models\Post',
            'table' => 'wixcore_blog_posts_categories',
            'scope' => 'isPublished',
            'count' => true
        ]
     ...
     * @param \WixCore\Pages\Classes\MenuItem $item Specifies the menu item.
