...
class Plugin extends PluginBase
{
    ...
    public function registerNavigation()
    {
        return [
            'blog' => [
                ...
                'icon'        => 'icon-pencil',
                'iconSvg'     => 'plugins/wixcore/blog/assets/img/blog-icon.svg',
    ...
    {
        # Зареєструйте зворотний виклик обробки тегів зображення
        TagProcessor::instance()->registerCallback(function($input, $preview) {
            if (!$preview) {
                return $input;
            }
            $html_result_pattern = '|\<img src="image" alt="([0-9]+)"([^>]*)\/>|m';
            $html_result_replace = '<span class="image-placeholder" data-index="$1"><span class="upload-dropzone"><span class="label">'. trans('wixcore.blog::lang.post.dropzone') .'</span><span class="indicator"></span></span></span>';
            return preg_replace($html_result_pattern, $html_result_replace, $input);
        });
    }
